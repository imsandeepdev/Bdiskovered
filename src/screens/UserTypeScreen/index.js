            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Text style={[Styles.accountTypeText,{marginTop:R.fontSize.Size10}]}>{'Select Account Type'}</Text>
                    ...
                    >
                       {
                        AccountType.map((item,index)=>{
                            return(
                                ...
                                backgroundColor={ selectedUser == item?.id ? R.colors.PrimaryApp_color : R.colors.white}
                                title={item.title}
                                TextColor={selectedUser == item?.id ? R.colors.white : R.colors.primaryTextColor}
                    ...
                    <View
                        ...
                        <Text
                            ...
                            style={{color:R.colors.appColor}}>{'Terms & Conditions'}</Text>
                            <Text> {'of usage.'}</Text>
                        </Text>
                        <Pressable
                            ...
                            style={({pressed}) => [
                            {
                                ...
                                borderWidth:1,
                                borderColor: acceptTerms ? R.colors.appColor : R.colors.placeHolderColor,
